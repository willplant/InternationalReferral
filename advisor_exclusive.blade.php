...
<div class="breadcrumbs">
	<div class="wrapper">
		...
		<a href="{{ URL::to('/exclusive' . ($page != 0 ? '/p' . $page : '')) }}" class="breadcrumb breadcrumb breadcrumb-advisors animate-opacity">
			<span class="light"></span>
			<span class="begin"></span>
			<span class="end"></span>
			IR Exclusive
		</a>
		@if(Request::is('exclusive/search*'))
	...
	<div class="wrapper advisor-content profile-small-sections">
		...
		<div class="wrapper-section">
			<div class="title translate_this" data-language="en">
				<span class="icon-40-comittee" title="IR - Comitee member" style="background-image: url({{ URL::to('/img/site-desktop/class-icon-comittee.png') }}); margin-right: 20px;"></span> Comittee Member
			</div>
		...
		<div class="wrapper-section">
			...
			<div class="content translate_this hide" data-language="es">
				<i>{{ $advisor->first_name . ' ' . $advisor->middle_name . ' ' . $advisor->last_name }} es el miembro de IR Exclusive para:</i><br />
				<ul style="padding-top: 20px;">
				@if ($advisor->practiceareas)
					@foreach ($advisor->practiceareas as $pa)
						@if($pa->name_es != "")
