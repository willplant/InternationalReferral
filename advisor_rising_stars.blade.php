...
<div id="background-profile-rising-stars">
</div>
<div id="background-profile-rising-stars-card">
</div>
<div class="breadcrumbs">
	<div class="wrapper">
		...
		@if(Request::is('rising-stars/search*'))
		<a href="{{ $url_back }}" class="breadcrumb breadcrumb-rising-stars-search animate-opacity">
			<span class="light"></span>
			<span class="begin"></span>
			<span class="end"></span>
			Result
...
<div id="advisors" class="section section-rising-stars advisor-profile-page">
	...
	<div class="wrapper advisor-content profile-small-sections">
		...
		<div class="wrapper-section">
			...
			<div class="content translate_this hide" data-language="es">
				<i>{{ $advisor->first_name . ' ' . $advisor->middle_name . ' ' . $advisor->last_name }} es el miembro de Rising Stars para:</i><br />
				<ul style="padding-top: 20px;">
				@if ($advisor->practiceareas)
					@foreach ($advisor->practiceareas as $pa)
						@if($pa->name_es != "")
