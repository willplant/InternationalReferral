...
<div id="background-profile-latin">
</div>
<div id="background-profile-latin-card">
</div>
<div class="breadcrumbs">
	<div class="wrapper">
		...
		<a href="{{ URL::to('/latin' . ($page != 0 ? '/p' . $page : '')) }}" class="breadcrumb breadcrumb breadcrumb-latin animate-opacity">
			<span class="light"></span>
			<span class="begin"></span>
			<span class="end"></span>
			IR Latin
		</a>
		@if(Request::is('latin/search*'))
		<a href="{{ $url_back }}" class="breadcrumb breadcrumb-latin-search animate-opacity">
			<span class="light"></span>
			<span class="begin"></span>
			<span class="end"></span>
			Result
		...
		<div class="translation">
			...
			<div class="language spanish active animate-opacity" data-code="es">En Español</div>
			<div class="language english animate-opacity" data-code="en">In english</div>
		</div>
...
<div id="advisors" class="section section-latin advisor-profile-page">
	<div class="wrapper advisor-detail-wrapper">
		<div class="left">
			...
			<div class="advisor-data">
				...
				@if (count($advisor->registers) > 1)
					<span class="translate_this hide" data-language="en">Classes</span>
					<span class="translate_this" data-language="es">Clases</span>
				@else
					<span class="translate_this hide" data-language="en">Class</span>
					<span class="translate_this" data-language="es">Clase</span>
				@endif
					<div class="classes-icons">
					@foreach ($advisor->registers as $register)
						@if ($register->id == 1)
							<div class="icon-40-exclusive-light" data-class="IR Exclusive"></div>
						@elseif ($register->id == 2)
							<div class="icon-40-rising-stars" data-class="IR Rising Stars"></div>
						@elseif ($register->id == 3)
							<div class="icon-40-latin" data-class="IR Latin"></div>
						@endif
					@endforeach
					</div>
				</div>
				@if (!empty($regions))
					...
					<span class="text translate_this hide" data-language="en">Jurisdiction</span>
					<span class="text translate_this" data-language="es">Jurisdicción</span>
				...
				@endif
				<div class="firm">
					<span class="translate_this hide" data-language="en">Firm</span>
					<span class="translate_this" data-language="es">Firma</span>
		...
		<div class="right">
			<div class="advisor-details">
				<div class="title translate_this hide" data-language="en">Contact details</div>
				<div class="title translate_this" data-language="es">Datos de contacto</div>
				<div class="details">
					<div class="detail-row">
						<div class="detail-title translate_this hide" data-language="en">Firm name</div>
						<div class="detail-title translate_this" data-language="es">Firma</div>
						<div class="detail">{{ htmlspecialchars_decode($advisor->firm->name) }}</div>
					</div>
					<div class="detail-row">
						<div class="detail-title translate_this hide" data-language="en">Address</div>
						<div class="detail-title translate_this" data-language="es">Dirección</div>
						<div class="detail">
							@if ($advisor->street)
					...
					<div class="detail-row">
						<div class="detail-title translate_this hide" data-language="en">Phone</div>
						<div class="detail-title translate_this" data-language="es">Teléfono</div>
				...
				<div class="contact-buttons">
					<a href="{{ $advisor->firm->url }}" target="_blank" class="link no-margin-left translate_this hide" data-language="en"><span class="light"></span>Visit firm website</a>
					<a href="{{ $advisor->firm->url }}" target="_blank" class="link no-margin-left translate_this" data-language="es"><span class="light"></span>Visita la firma</a>
					@if(!empty($advisor->vcita_id) && $advisor->vcita_id != "0")
					<a class="link translate_this hide" data-language="en" href="http://www.vcita.com/meeting_scheduler?v={{ $advisor->vcita_id }}" target="_blank"><span class="light"></span>Book a meeting</a>
					<a class="link translate_this" data-language="es" href="http://www.vcita.com/meeting_scheduler?v={{ $advisor->vcita_id }}" target="_blank"><span class="light"></span>Concertar una cita</a>
					@endif
				</div>
			</div>
		</div>
	...
	<div class="wrapper advisor-content profile-small-sections">
		...
		<div class="wrapper-section">
			<div class="title translate_this hide" data-language="en">Practice Areas</div>
			<div class="title translate_this" data-language="es">Áreas de práctica</div>
			<div class="content translate_this hide" data-language="en">
			...
			<div class="content translate_this" data-language="es">
		...
		<div class="wrapper-section">
			<div class="title translate_this hide" data-language="en">Links</div>
			<div class="title translate_this" data-language="es">Enlaces</div>
			<div style="padding-top: 20px;">
	...
	<div class="wrapper advisor-content">
		...
		@if (count($news) > 0)
			<div class="wrapper-section news-section">
				<div class="title translate_this hide" data-language="en"><span class="news-icon"></span>News by {{ $advisor->first_name }}</div>
				<div class="title translate_this" data-language="es"><span class="news-icon"></span>Noticias por {{ $advisor->first_name }}</div>
				<div class="news">
				<?php $grey = false; ?>
				...
				<div class="load-more translate_this hide" data-language="en" data-page="1" data-user="{{ $advisor->id }}">Load more news</div>
				<div class="load-more translate_this" data-language="es" data-page="1" data-user="{{ $advisor->id }}">Ver más noticias</div>
			</div>
		@endif
	</div>
</div>
