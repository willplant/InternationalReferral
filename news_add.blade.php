...
<div class="wrapper settings-wrapper profile-settings-page news-add-page" id="news">
	...
	<div class="row">
		...
		<div class="explain-content">
			Now let's get started! Fill in the tags for your article and then write your article. If you wish, you may add a Spanish translation for your article as well. See the instructions below for more information.
		</div>
		...
		<div class="interests">
			...
			@endif
				...
				@foreach($member->registers as $pa)
					<option value="{{ $pa->id }}" data-id="{{ $pa->id }}">{{ $pa->name }}</option>
				@endforeach
			</select>
		</div>
	...
	<div class="row">
		<div class="explain-content">
			Here you can create your article. When you feel satisfied - just press <strong>"Submit Article"</strong>! If you wish to have a Spanish translation, press Spanish below to add it. If you wish to remove a translation, simply remove all the text and the translation will be removed.
		</div>
	</div>
